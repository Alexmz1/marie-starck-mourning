...
export default function HeroSection() {
  return (
    <section
      id="accueil"
      className="relative flex flex-col items-center justify-center text-center min-h-[80vh] overflow-hidden px-6"
      style={{ backgroundColor: '#faf8f3' }}
    >
      <div className="max-w-5xl w-full space-y-8 z-10">
        <div className="space-y-4">
          <div
            className="inline-block px-4 py-2 text-black text-sm font-light mb-4 border border-[#276f88]"
          >
            Artisan fleuriste
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
          <a
            href="#compositions"
            className="btn-primary-gray px-8 py-3 font-light flex items-center"
          >
          ...
          <Link
            href="/contact"
            className="btn-secondary-gray px-8 py-3 font-light flex items-center"
          >
            <svg
